...
var otherTile = null; // This will track the empty tile (16.jpg)

var turns = 0;
var imgOrder = ["7", "4", "1", "5", "9", "3", "2", "6", "8", "12", "13", "10", "16", "14", "15", "11"]; // 16.jpg is the empty tile
...
window.onload = function() {
    ...
    for (let r = 0; r < rows; r++) {
        for (let c = 0; c < columns; c++) {
            ...
            tile.src = "../img/SH2/" + imgNumber + ".jpg"; // Set image
...
function dragEnd() {
    ...
    // Ensure only the empty tile (16.jpg) can be swapped
    if (!otherTile.src.includes("16.jpg")) return;
